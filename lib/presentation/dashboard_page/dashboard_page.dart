                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.specialsItemList.length,
                        itemBuilder: (context, index) {
                          SpecialsItemModel model = controller
                              .dashboardModelObj.value.specialsItemList[index];
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.upcomingItemList.length,
                        itemBuilder: (context, index) {
                          UpcomingItemModel model = controller
                              .dashboardModelObj.value.upcomingItemList[index];
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.featuredItemList.length,
                        itemBuilder: (context, index) {
                          FeaturedItemModel model = controller
                              .dashboardModelObj.value.featuredItemList[index];
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.upcoming1ItemList.length,
                        itemBuilder: (context, index) {
                          Upcoming1ItemModel model = controller
                              .dashboardModelObj.value.upcoming1ItemList[index];
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.categoriesItemList.length,
                        itemBuilder: (context, index) {
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller
                            .dashboardModelObj.value.specialItemList.length,
                        itemBuilder: (context, index) {
                          SpecialItemModel model = controller
                              .dashboardModelObj.value.specialItemList[index];
